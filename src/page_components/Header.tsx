...
import profile from "../assets/Joseph.jpg";
import { Avatar, AvatarFallback } from "@/components/ui/avatar";
import { AvatarImage } from "@radix-ui/react-avatar";

export default function Header() {
  return (
    <header className="flex flex-row relative p-2 w-full h-10  top-0 bg-white">
      <div className="relative w-3/5">
        ...
        <Input
          ...
          className="py-3 pl-12 pr-4 bg-slate-50  rounded-md "
        />
      </div>
